...
var add = "insert into temps(RanchID,MilktankID,Milkstatus,Temp,Alarm,Date,Time) values(" + muchanid + "," + tankid + ",'制冷','5',0,'" + getNowFormatDate() + "','" + getTime() + "')";
...
function do_it(callback) {
    ...
    var update = "insert into temps(RanchID,MilktankID,Milkstatus,Temp,Alarm,Date,Time) values(" + muchanid + "," + tankid + ",'制冷','" + temp + "'," + alarm + ",'" + getNowFormatDate() + "','" + getTime() + "')";
